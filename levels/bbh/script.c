...
const LevelScript level_bbh_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_KBI_PLATFORM, KBI_platform_geo), 
	/* Fast64 begin persistent block [level commands] */
	/* Fast64 end persistent block [level commands] */

	AREA(1, bbh_area_1),
		WARP_NODE(0x0A, LEVEL_CASTLE, 0x01, 0x03, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x32, WARP_CHECKPOINT),
		...
		WARP_NODE(0x0E, LEVEL_BBH, 0x03, 0x0A, WARP_CHECKPOINT),
		...
		OBJECT(MODEL_MR_I, -137, 80, -1675, 0, 0, 0, 0x00000000, bhvMrI),
		...
		OBJECT(MODEL_BBH_RIPPLES, 193, 409, 3018, 0, 90, 0, 0x00000000, bhvBbhripples),
		...
		OBJECT(MODEL_NONE, 193, 409, 3018, 0, 90, 0, 0x000D0000, bhvWarp),
		OBJECT(MODEL_NONE, 193, 409, -3093, 0, 90, 0, 0x000E0000, bhvWarp),
		OBJECT(MODEL_NONE, 60, 80, 0, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_BBH_RIPPLES, 193, 409, -3093, 0, 90, 0, 0x00000000, bhvBbhripples),
	...
	END_AREA(),
	AREA(3, bbh_area_3),
		WARP_NODE(0x0A, LEVEL_BBH, 0x01, 0x0E, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x32, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE, 0x01, 0x64, WARP_CHECKPOINT),
		WARP_NODE(0x0C, LEVEL_BBH, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_LUIGI_CUSTOM, -3830, 210, -4074, 0, 90, 0, 0x00000000, bhvLuigi),
		MARIO_POS(0x03, 90, 4632, 366, 7296),
		OBJECT(MODEL_NONE, 4632, 366, 7296, 0, 90, 0, (0x0A << 16), bhvAirborneWarp),
		OBJECT(MODEL_NONE, -3854, 519, -5557, 0, 90, 0, (0x0C << 16), bhvWarp),
		OBJECT(MODEL_STAR, -3401, 519, -5557, 0, 90, 0, 0x03000000, bhvStar),
		OBJECT(MODEL_BBH_RIPPLES, -3854, 519, -5557, 0, 90, 0, 0x00000000, bhvBbhripples),
		TERRAIN(bbh_area_3_collision),
		MACRO_OBJECTS(bbh_area_3_macro_objs),
		SET_BACKGROUND_MUSIC(0x25, SEQ_GHOST_WALTZ),
		TERRAIN_TYPE(TERRAIN_SPOOKY),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
	AREA(4, bbh_area_4),
		WARP_NODE(0x0A, LEVEL_BBH, 0x03, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x32, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE, 0x01, 0x64, WARP_CHECKPOINT),
		MARIO_POS(0x04, 90, 5373, 1295, 7296),
		OBJECT(MODEL_KBI_PLATFORM, 5346, 570, 6245, 0, 90, 0, 0x00000000, bhvKBICheckerboardPlatform),
		OBJECT(MODEL_STAR, 5485, 820, -8014, 0, 90, 0, (0x04 << 24), bhvStar),
		OBJECT(MODEL_BETA_BOO_KEY, 5346, 570, -7324, 0, 90, 0, 0x00000000, bhvStaticObject),
		OBJECT(MODEL_NONE, 5373, 1295, 7296, 0, 90, 0, (0x0A << 16), bhvAirborneWarp),
