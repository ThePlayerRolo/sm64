...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_NONE, 527, 14, 1441, 0, 0, 0, 0x00020000, bhvWarp),
		MARIO_POS(0x01, 0, -1433, 337, 1298),
		OBJECT(MODEL_BOBOMB_BUDDY_CUSTOM, 407, -49, 225, 0, 93, 0, (00 << 24) | (01 << 16) | (00 << 8) | (00), bhvBobombBuddy),
		OBJECT(MODEL_NONE, -1433, 337, 1298, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -1103, -49, 1307, 0, 93, 0, 0x000B0000, bhvPaintingDeathWarp),
